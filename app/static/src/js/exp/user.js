...
function component_action(id) {
    return `
        <a href="/exp/update/N00${id}" class="btn btn-primary text-white">編輯</a>
        <a href="/exp/show/N00${id}" class="btn btn-secondary text-white">查看</a>
        <a href="/exp/destroy/N00${id}" class="btn btn-danger text-white">刪除</a>
    `
}
