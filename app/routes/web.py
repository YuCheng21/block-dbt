...
def init_blueprint():
    ...
    parent.add_url_rule('/build/confirm/<id>', None, ctrl.exp.parent.confirm4build, methods=['GET', 'POST'])
    parent.add_url_rule('/build/auth/<id>', None, ctrl.exp.parent.build2auth, methods=['GET'])
    parent.add_url_rule('/experiment/confirm/<id>', None, ctrl.exp.parent.confirm4exp, methods=['GET', 'POST'])
